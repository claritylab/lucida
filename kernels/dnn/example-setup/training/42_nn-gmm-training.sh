#!/bin/bash
# acoustic model training for a Tandem system

AMT=./executables/acoustic-model-trainer.*
CONFIG=config/nn-gmm-training.config
INITALIGN=data/am.lda-2.final-alignment.cache
NAME=am.tandem
NSPLIT=7
NITER=3
LDA_ITER=2
...
align data/$NAME.${NSPLIT}-$NITER.mix data/$NAME.final-alignment.cache
accumulate "" data/$NAME.final-single-gaussian.mix data/$NAME.final-alignment.cache
