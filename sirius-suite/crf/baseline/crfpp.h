...
CRFPP_DLL_EXTERN crfpp_model_t *crfpp_model_from_array_new(int, char **,
                                                           const char *,
                                                           size_t);
...
CRFPP_DLL_EXTERN void crfpp_set_penalty(crfpp_t *, size_t i, size_t j,
                                        double penalty);
...
CRFPP_DLL_EXTERN double crfpp_next_transition_cost(crfpp_t *, size_t, size_t,
                                                   size_t);
CRFPP_DLL_EXTERN double crfpp_prev_transition_cost(crfpp_t *, size_t, size_t,
                                                   size_t);
...
CRFPP_DLL_EXTERN const char *crfpp_parse_tostr2(crfpp_t *, const char *,
                                                size_t);
CRFPP_DLL_EXTERN const char *crfpp_parse_tostr3(crfpp_t *, const char *, size_t,
                                                char *, size_t);
...
class CRFPP_DLL_CLASS_EXTERN Model {
 public:
  ...
  // open model with parameters in argv[].
  // e.g, argv[] = {"CRF++", "-v3"};
  virtual bool openFromArray(int argc, char **argv, const char *model_buf,
                             size_t model_size) = 0;

  // open model with parameter arg, e.g. arg = "-m model -v3";
  virtual bool openFromArray(const char *arg, const char *model_buf,
                             size_t model_size) = 0;
#endif
...
class CRFPP_DLL_CLASS_EXTERN Tagger {
 public:
  ...
  // [k-th tag at(i+1)-th token]
  virtual const int *next_transition_vector(size_t i, size_t j,
                                            size_t k) const = 0;

  // return transition feature vector of [j-th tag at i-th token] to
  // [k-th tag at(i-1)-th token]
  virtual const int *prev_transition_vector(size_t i, size_t j,
                                            size_t k) const = 0;
#endif
  ...
  virtual const char *parse(const char *str, size_t size1, char *result,
                            size_t size2) = 0;
#endif
