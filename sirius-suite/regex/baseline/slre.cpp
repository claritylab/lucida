...
static int match(const struct slre *r, int pc, const char *s, int len, int *ofs,
                 struct cap *caps) {
...
int main(int argc, char *argv[]) {
  ...
  int numExps = fill(f, exps, temp, 100);
  ...
  int numQs = fill(f1, bufs, buf_len, 100);
