...
//                      Lukas Burget  Johns Hopkins University (author: Daniel
//                      Povey)
...
class DecodableAmSgmm2 : public DecodableInterface {
 public:
  DecodableAmSgmm2(const AmSgmm2 &sgmm, const TransitionModel &tm,
                   const Matrix<BaseFloat> &feats,
                   const std::vector<std::vector<int32> > &gselect,
                   BaseFloat log_prune, Sgmm2PerSpkDerivedVars *spk)
      : sgmm_(sgmm),
        spk_(spk),
        trans_model_(tm),
  ...
  DecodableAmSgmm2(const AmSgmm2 &sgmm, const TransitionModel &tm,
                   const Matrix<BaseFloat> *feats,
                   const std::vector<std::vector<int32> > *gselect,
                   Sgmm2PerSpkDerivedVars *spk, BaseFloat log_prune)
      : sgmm_(sgmm),
        spk_(spk),
        trans_model_(tm),
        feature_matrix_(feats),
...
class DecodableAmSgmm2Scaled : public DecodableAmSgmm2 {
 public:
  DecodableAmSgmm2Scaled(const AmSgmm2 &sgmm, const TransitionModel &tm,
                         const Matrix<BaseFloat> &feats,
                         const std::vector<std::vector<int32> > &gselect,
