...
inline void cublas_gemm(char transa, char transb, int m, int n, int k,
...
inline void cublas_trsm(int m, int n, float alpha, const float* A, int lda,
                        float* B, int ldb) {
  cublasStrsm('l', 'u', 'n', 'n', m, n, alpha, A, lda, B, ldb);
}
inline void cublas_trsm(int m, int n, double alpha, const double* A, int lda,
                        double* B, int ldb) {
  cublasDtrsm('l', 'u', 'n', 'n', m, n, alpha, A, lda, B, ldb);
}
inline void cublas_syrk(char uplo, char trans, int n, int k, float alpha,
                        const float* A, int lda, float beta, float* C,
                        int ldc) {
  cublasSsyrk(uplo, trans, n, k, alpha, A, lda, beta, C, ldc);
}
inline void cublas_syrk(char uplo, char trans, int n, int k, double alpha,
                        const double* A, int lda, double beta, double* C,
                        int ldc) {
  cublasDsyrk(uplo, trans, n, k, alpha, A, lda, beta, C, ldc);
}
inline float cublas_dot(int n, const float* x, int incx, const float* y,
                        int incy) {
  return cublasSdot(n, x, incx, y, incy);
}
inline double cublas_dot(int n, const double* x, int incx, const double* y,
                         int incy) {
...
inline void cublas_copy(int n, const float* x, int incx, float* y, int incy) {
  cublasScopy(n, x, incx, y, incy);
}
inline void cublas_copy(int n, const double* x, int incx, double* y, int incy) {
...
inline void cublas_axpy(int n, float alpha, const float* x, int incx, float* y,
                        int incy) {
  cublasSaxpy(n, alpha, x, incx, y, incy);
}
inline void cublas_axpy(int n, double alpha, const double* x, int incx,
                        double* y, int incy) {
  cublasDaxpy(n, alpha, x, incx, y, incy);
}
inline void cublas_gemv(char trans, int m, int n, float alpha, const float* A,
                        int lda, const float* x, int incx, float beta, float* y,
                        int incy) {
  cublasSgemv(trans, m, n, alpha, A, lda, x, incx, beta, y, incy);
}
inline void cublas_gemv(char trans, int m, int n, double alpha, const double* A,
                        int lda, const double* x, int incx, double beta,
                        double* y, int incy) {
  cublasDgemv(trans, m, n, alpha, A, lda, x, incx, beta, y, incy);
}

inline void cublas_spmv(char uplo, int n, float alpha, const float* AP,
                        const float* x, int incx, float beta, float* y,
                        int incy) {
  cublasSspmv(uplo, n, alpha, AP, x, incx, beta, y, incy);
}
inline void cublas_spmv(char uplo, int n, double alpha, const double* AP,
...
// column-by-column.
inline void cublas_tpmv(char trans, int n, const float* Ap, float* x,
                        int incx) {
  return cublasStpmv('u', trans, 'n', n, Ap, x, incx);
}
inline void cublas_tpmv(char trans, int n, const double* Ap, double* x,
                        int incx) {
  return cublasDtpmv('u', trans, 'n', n, Ap, x, incx);
}

inline void cublas_spr(char uplo, int n, float alpha, const float* x, int incx,
                       float* AP) {
