...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "Usage: nnet-latgen-faster-parallel [options] <nnet-in> "
    ...
    if (ClassifyRspecifier(fst_in_str, NULL, NULL) == kNoRspecifier) {
...

      {
        for (; !feature_reader.Done(); feature_reader.Next()) {
          ...
          DecodableAmNnetParallel *nnet_decodable = new DecodableAmNnetParallel(
              trans_model, am_nnet, new CuMatrix<BaseFloat>(features),
      ...
      for (; !fst_reader.Done(); fst_reader.Next()) {
        ...
        bool pad_input = true;
        DecodableAmNnetParallel *nnet_decodable = new DecodableAmNnetParallel(
            trans_model, am_nnet, new CuMatrix<BaseFloat>(features), pad_input,
            acoustic_scale);
