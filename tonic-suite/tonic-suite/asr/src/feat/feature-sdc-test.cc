...
static void UnitTestCompareWithDeltaFeatures(Matrix<BaseFloat> &raw_features,
                                             int32 window) {
  ...
  ComputeDeltas(deltas_opts, raw_features, &deltas_features);
  ComputeShiftedDeltas(shifted_deltas_opts, raw_features,
