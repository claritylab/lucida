...
int main(int argc, char *argv[]) {
  ...
  try {
    const char *usage =
        ...
        "e.g.: \n"
        " ivector-compute-dot-products trials ark:train_ivectors.scp "
        "ark:test_ivectors.scp trials.scored\n"
    ...
    if (num_done != 0) {
      ...
      KALDI_LOG << "Mean dot-product was " << mean
                << ", standard deviation was " << stddev;
    }
