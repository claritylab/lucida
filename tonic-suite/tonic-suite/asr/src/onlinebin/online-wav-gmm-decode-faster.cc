...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "Caution: the last few frames of the wav file may not be decoded "
        "properly.\n"
        ...
        "scp:wav.scp model HCLG.fst words.txt '1:2:3:4:5' ark,t:trans.txt "
        "ark,t:ali.txt";
    ...
    std::string wav_rspecifier = po.GetArg(1), model_rspecifier = po.GetArg(2),
