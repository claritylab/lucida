...
/** @file
    ...
    neural-net training examples, mostly discriminative neural-net training
   examples,
...
struct SplitDiscriminativeExampleConfig {
  ...
  void Register(OptionsItf *po) {
    po->Register("max-length", &max_length,
                 "Maximum length allowed for any "
    ...
    // See "Sequence-discriminative training of deep neural networks", Vesely et
    // al,
    ...
    po->Register("excise", &excise,
                 "Set to false to disable excising un-needed "
...
/**
   ...
   used as num_weight and den_weight, for an additional diagnostic, and the
   total
