...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        "Generate lattices using likelihood matrices, using arc lattices from "
        "forward path.\n"
        "Usage: latgen-tracking-mapped [options] model-in "
        "(fst-in|fsts-rspecifier) loglike-rspecifier"
