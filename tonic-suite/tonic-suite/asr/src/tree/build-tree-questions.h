...
///  See \ref tree_internals (and specifically \ref treei_func_questions) for
///  context.
/// \ingroup tree_group
/// @{
...
/// of different keys.
struct QuestionsForKey {  // Configuration class associated with a particular
                          // key
...
/// to increase
/// likelihood. It is perhaps a bit more than an options class, as it contains
/// the
/// actual questions.
class Questions {  // careful, this is a class.
 public:
  ...
  /// Initializer with arguments.  After using this you would have to set up the
  /// config for each key you
