...
class AccumAmDiagGmm {
 public:
  ...
  void AccumulateForGaussian(const AmDiagGmm &am,
                             const VectorBase<BaseFloat> &data, int32 gmm_index,
                             int32 gauss_index, BaseFloat weight);
  ...
  BaseFloat TotStatsCount()
      const;  // returns the total count got by summing the count
...
void MapAmDiagGmmUpdate(const MapDiagGmmOptions &config,
                        ...
                        AmDiagGmm *gmm, BaseFloat *obj_change_out,
                        BaseFloat *count_out);
...
typedef RandomAccessTableReader<KaldiObjectHolder<AmDiagGmm> >
    RandomAccessMapAmDiagGmmReader;
typedef RandomAccessTableReaderMapped<KaldiObjectHolder<AmDiagGmm> >
    RandomAccessMapAmDiagGmmReaderMapped;
typedef SequentialTableReader<KaldiObjectHolder<AmDiagGmm> >
