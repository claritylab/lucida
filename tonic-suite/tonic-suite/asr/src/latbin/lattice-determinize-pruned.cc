...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "acoustic states)\n"
        "for each input-symbol sequence.  This version does pruning as part of "
        "the\n"
        ...
        "on lattices.\n"
        "\n"
        "Usage: lattice-determinize-pruned [options] lattice-rspecifier "
        "lattice-wspecifier\n"
        " e.g.: lattice-determinize-pruned --acoustic-scale=0.1 --beam=6.0 "
        "ark:in.lats ark:det.lats\n";
    ...
    fst::DeterminizeLatticePrunedOptions
        opts;  // Options used in DeterminizeLatticePruned--
