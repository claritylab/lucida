...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "Usage: lattice-align-words [options] <word-boundary-file> <model> "
        "<lattice-rspecifier> <lattice-wspecifier>\n"
        " e.g.: lattice-align-words  --silence-label=4320 "
        "--partial-word-label=4324 \\\n"
        "   data/lang/phones/word_boundary.int final.mdl ark:1.lats "
        "ark:aligned.lats\n"
    ...
    std::string word_boundary_rxfilename = po.GetArg(1),
