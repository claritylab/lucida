...
void ConvertLattice(
    ...
    MutableFst<ArcTpl<
        CompactLatticeWeightTpl<LatticeWeightTpl<double>, Int> > > *ofst) {
...
void ConvertLattice(
    ...
    MutableFst<ArcTpl<
        CompactLatticeWeightTpl<LatticeWeightTpl<float>, Int> > > *ofst) {
...
void ScaleLattice(const vector<vector<ScaleFloat> > &scale,
