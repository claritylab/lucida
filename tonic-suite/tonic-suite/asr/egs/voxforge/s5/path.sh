...
export PATH=$KALDI_ROOT/src/ivectorbin:$KALDI_ROOT/src/online2bin:$KALDI_ROOT/src/nnet2bin:$KALDI_ROOT/src/nnetbin:$KALDI_ROOT/src/onlinebin:$PWD/utils/:$KALDI_ROOT/src/bin:$KALDI_ROOT/tools/openfst/bin:$KALDI_ROOT/src/fstbin/:$KALDI_ROOT/src/gmmbin/:$KALDI_ROOT/src/featbin/:$KALDI_ROOT/src/lm/:$KALDI_ROOT/src/sgmmbin/:$KALDI_ROOT/src/sgmm2bin/:$KALDI_ROOT/src/fgmmbin/:$KALDI_ROOT/src/latbin/:$PWD:$PATH

# VoxForge data will be stored in:
export DATA_ROOT="/home/ypkang/kaldi-trunk/egs/voxforge/s5/data_set"    # e.g. something like /media/secondary/voxforge
