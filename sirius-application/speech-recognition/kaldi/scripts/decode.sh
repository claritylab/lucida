...
$KALDI_DIR/src/online2bin/online2-wav-nnet2-latgen-faster --do-endpointing=false \
  --online=false \
  ...
  nnet_a_gpu_online/smbr_epoch2.mdl graph/HCLG.fst "ark:echo utterance-id1 utterance-id1|" "scp:echo utterance-id1 $WAV_FILE|" \
  ark:/dev/null
