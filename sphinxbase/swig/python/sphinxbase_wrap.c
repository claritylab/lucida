...
SWIGINTERN FsgModel *new_FsgModel__SWIG_0(fsg_model_t *ptr){
        return ptr;
    }
...
SWIGINTERN FsgModel *new_FsgModel__SWIG_1(char const *path,LogMath *logmath,float w){
...
SWIGINTERN JsgfRule *JsgfIterator_next(JsgfIterator *self){
    if (self->ptr) {
      JsgfRule *value = next_JsgfIterator(self->ptr);
...
SWIGINTERN PyObject *_wrap_new_FsgModel__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  result = (FsgModel *)new_FsgModel__SWIG_0(arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_FsgModel", _wrap_new_FsgModel, METH_VARARGS, (char *)"\n"
		...
		"new_FsgModel(char const * path, LogMath * logmath, float w) -> FsgModel\n"
		""},
	 ...
	 { (char *)"FsgModel_add_alt", _wrap_FsgModel_add_alt, METH_VARARGS, (char *)"\n"
		...
		""},
	 { (char *)"FsgModel_write", _wrap_FsgModel_write, METH_VARARGS, (char *)"\n"
		"FsgModel_write(FsgModel self, FILE * file)\n"
		"\n"
		"Write FSG to a file. \n"
		""},
	 ...
	 { (char *)"NGramModel_recode", _wrap_NGramModel_recode, METH_VARARGS, (char *)"\n"
		"NGramModel_recode(NGramModel self, char const * src, char const * dst)\n"
		"\n"
